...
import org.apache.streampark.utils.options.SinkOptions;
import lombok.Data;
...
public class SinkTable {
    ...
    public static String buildSinkCreateTableFlinkSql(String selectFields, Configuration sinkConfig) {
        ...
        String create_table_flink_sql = "CREATE  TABLE " + SINK_TABLENAME + " \n" +
                "(" + colsBuf.toString() +
